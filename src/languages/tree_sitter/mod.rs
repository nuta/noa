...
pub fn get_highlights_query(name: &str) -> Option<&str> {
   match name {
        ...
        "cpp" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/cpp/highlights.scm")),
        "javascript" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/javascript/highlights.scm")),
        "python" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/python/highlights.scm")),
        "go" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/go/highlights.scm")),
        "bash" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/bash/highlights.scm")),
        "html" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/html/highlights.scm")),
        ...
        "markdown" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/markdown/highlights.scm")),
        ...
        "yaml" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/yaml/highlights.scm")),
...
pub fn get_indents_query(name: &str) -> Option<&str> {
   match name {
        ...
        "cpp" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/cpp/indents.scm")),
        "javascript" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/javascript/indents.scm")),
        "python" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/python/indents.scm")),
        "go" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/go/indents.scm")),
        "html" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/html/indents.scm")),
        ...
        "yaml" => Some(include_str!("../tree_sitter/nvim_treesitter/queries/yaml/indents.scm")),
    _ => None
    }
}
